...
if exists("python_highlight_builtin_objs") && python_highlight_builtin_objs != 0
  ...
  syn keyword pythonBuiltinObj	__debug__ __doc__ __file__ __name__ __package__ __class__ __dict__ __bases__ __module__
endif

if exists("python_highlight_builtin_funcs") && python_highlight_builtin_funcs != 0
  " Builtin functions
  syn keyword pythonBuiltinFunc	__import__ __init__ abs all any apply __get__ __set__
