...
"!!!custimized syntax here:
syn match  matlabCustomizeFun 	  '\(function\s*.\{-}[= ]\)\@<=\a[[:alnum:]_]*\ze('
highlight matlabCustomizeFun ctermfg=Green guifg=Magenta

syn match matlabClass		'\(classdef\s\+\)\@<=\<\h\w*\>'
highlight matlabClass guifg=Green
...
"RF ToolBox 
"Method
syn keyword matlabFunc analyze freqresp ispassive stepresp timeresp circle table listformat listparam getop
syn keyword matlabFunc setop read write writeva calculate extract getz0 restore
"Functions
syn keyword matlabFunc cascadesparams deembedsparams gamma2z gammain gammaml gammams makepassive
syn keyword matlabFunc powergain rationalfit s2tf stabilityk stabilitymu vswr z2gamma smithchart
syn keyword matlabFunc copy getdata abcd2h abcd2s abcd2y h2abcd h2g h2s h2y h2z s2abcd s2h s2s
syn keyword matlabFunc s2scc s2scd s2sdc s2sdd s2smm s2t s2y s2z smm2s snp2smp t2s y2abcd y2h 
syn keyword matlabFunc y2s y2z z2abcd z2h z2s z2y rftool
...
"cutimized by xiong
"highlight matlabCustomizeKw ctermfg=Green guifg=Magenta
